...
These are all the terminal commands used so far for setting up and running the **query_gnomad_graphql.py** script on macOS (Google Drive version).
...
# [Python code identical to the script in the txt version]
EOF
```
